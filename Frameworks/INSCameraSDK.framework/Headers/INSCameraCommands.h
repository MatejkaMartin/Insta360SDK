 ...
 * availability(ONE X)
 */
- (void)openCameraWifiWithCompletion:(void(^)(NSError * _Nullable error))completion;
 ...
 * availability(ONE X)
 */
- (void)closeCameraWifiWithCompletion:(void(^)(NSError * _Nullable error))completion;
...
- (void)setActiveSensorWithDevice:(INSSensorDevice)device
                    completion:(void (^)(NSError * _Nullable error, NSString * _Nullable mediaOffset))completion;
