...
@property (nonatomic) BOOL useDynamicStitching;                //default:NO
...
/// nil时会关闭color plus，不为nil时将会使用,  目前仅预览使用
@property (nonatomic, strong, nullable)INSSingleHDRInfo *singleHDR;
