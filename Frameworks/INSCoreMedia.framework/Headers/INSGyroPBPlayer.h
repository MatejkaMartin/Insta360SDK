...
- (nullable instancetype)initWithPBGyroData:(INSExtraGyroData *)pbGyro gyroStabilizerData:(NSData *)gyroStabilizerData  multipleBatch:(BOOL)multipleBatch;

- (void)serializeStabilizerFilterCompletion:(void(^)(NSData * _Nullable gyroStabilizerData, NSError * _Nullable error))completion;
